...
//         this.leftAngle = this.leftStrength = this.rightAngle = this.rightStrength = this.xCoordinate = this.yCoordinate = this.testCount = 0;
...
//         // setting the listeners for both the joysticks
...
//             String url = "http://10.0.0.65:1500/joystick_left?leftAngle=" + leftAngle +
...
//             this.rightStrength = strength;
//             this.testCount++;
//             System.out.println(this.testCount);

//             String url = "http://10.0.0.65:1500/joystick_right?rightAngle=" + rightAngle +
...
//         jsonButton.setOnClickListener(new View.OnClickListener() { //onclick listener for joystick
//             @Override
//             public void onClick(View view) {
