...
class ObjectDetection:
    ...
    def __init__(self, pipeline=None, labels=None, confidence_threshold=None, weight_path=None, nn_path=None): #not sure what is weight-path here
    ...
    def detect(self, text_color=None, camera='main') -> list:
        ...
        if inDet is not None:
            detections = inDet.getRaw().data  # should be inDet.detections <------ discussion needed

        if camera.__eq__('main'):
            if inRight is not None:
                frame = inRight.getRaw().data  # should be getcvframe <------ discussion needed
            else:
            ...
            if inManip is not None:
                frame_manip = inManip.getRaw().data  # should be getcvframe <------ discussion needed
            else:
